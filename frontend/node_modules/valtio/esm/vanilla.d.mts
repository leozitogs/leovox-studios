...
declare const createHandlerDefault: <T extends object>(isInitializing: () => boolean, addPropListener: (prop: string | symbol, propValue: unknown) => void, removePropListener: (prop: string | symbol) => void, notifyUpdate: (op: Op | undefined) => void) => ProxyHandler<T>;
declare const createOpDefault: (type: "set" | "delete", prop: symbol | string, ...args: unknown[]) => Op;
...
export declare function unstable_enableOp(enabled?: boolean | typeof createOpDefault): void;
export {};
